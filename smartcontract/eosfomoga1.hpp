...
const account_name contract_fee_account = N(eosfomoggfee);
...
class eosfomogame1: public contract {
public:
    eosfomogame1(account_name self)
            : contract(self),
...
EOSIO_ABI_EX(eosfomogame1, (withdraw) (transfer) (create))
